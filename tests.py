...
# query1 = [
#     Punteggio(day="200", name="Connections", timestamp=10, tries="1", extra=0, user_id=111111111, user_name="Davide"),
#     Punteggio(day="200", name="Connections", timestamp=8, tries="1", extra=0, user_id=555555555, user_name="Francesco"),       # lost play
